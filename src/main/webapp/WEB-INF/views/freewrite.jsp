        ...
        <div class="col-sm-8">
            <form style="text-align: left">
                ...
                <div style="margin-bottom: 15px;">
                    이름 - 최대 8글자<input type="name" class="form-control" name="name" style="width: 15%;"maxlength="8">
                </div>
                <%--<div style="margin-bottom: 15px;">--%>
                    <%--비밀번호 - 최대 12글자<input type="password" class="form-control" name="password" style="width: 15%;"maxlength="12">--%>
                <%--</div>--%>
                <div style="margin-top: 25px;">
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="content" rows="3" placeholder="내용을 입력하세요."></textarea>
                </div>
            </form>
